...
class Benchmark(abc.ABC):
    ...
    def get_task_init_states(self, i):
        ...
        # LIBERO's benchmark init states are trusted repository assets, not model weights.
        # PyTorch 2.6+ defaults to weights_only=True, which cannot read their NumPy payload.
